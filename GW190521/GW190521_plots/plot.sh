pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/ground_based_acc/separate_runs/GW190521/demarg_nonzero_acc_new_model.hdf \
    --output-file separate_nonzero_a_GW190521_masses.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/ground_based_acc/separate_runs/GW190521/demarg_nonzero_acc_new_model.hdf \
    --output-file separate_nonzero_GW190521_spins.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/ground_based_acc/separate_runs/GW190521/demarg_nonzero_acc_new_model.hdf \
    --output-file separate_nonzero_a_GW190521_extrinsic.png \
    --parameters \
        ra dec \
