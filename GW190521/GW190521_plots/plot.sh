pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW190521/demarg_nonzero_acc_large.hdf \
    --output-file A1_nonzero_large_a_GW190521_masses.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW190521/demarg_nonzero_acc_large.hdf \
    --output-file A2_nonzero_large_a_GW190521_spins.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW190521/demarg_nonzero_acc_large.hdf \
    --output-file A3_nonzero_large_a_GW190521_extrinsic.png \
    --parameters \
        ra dec \
