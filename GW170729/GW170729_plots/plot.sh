pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW170729/demarg_nonzero_a.hdf \
    --output-file A1_nonzero_a_GW170729_masses.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW170729/demarg_nonzero_a.hdf \
    --output-file A2_nonzero_a_GW170729_spins.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW170729/demarg_nonzero_a.hdf \
    --output-file A3_nonzero_a_GW170729_extrinsic.png \
    --parameters \
        ra dec \
