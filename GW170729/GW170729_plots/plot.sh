pycbc_inference_plot_posterior --verbose\
    ...
    --output-file A1_separate_nonzero_a_GW170729_masses.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file  /home/lroy02/ground_based_acc/separate_runs/GW170729/demarg_nonzero_a_GW170729.hdf \
    --output-file A2_separate_nonzero_a_GW170729_spins.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file  /home/lroy02/ground_based_acc/separate_runs/GW170729/demarg_nonzero_a_GW170729.hdf \
    --output-file A3_separate_nonzero_a_GW170729_extrinsic.png \
    --parameters \
        ra dec \
