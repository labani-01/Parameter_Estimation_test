pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW170823/demarg_nonzero_acc_large.hdf \
    --output-file A1_nonzero_a_GW170823_masses.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW170823/demarg_nonzero_acc_large.hdf \
    --output-file A2_nonzero_a_GW170823_spins.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/acceleration_project/GW170823/demarg_nonzero_acc_large.hdf \
    --output-file A3_nonzero_a_GW170823_extrinsic.png \
    --parameters \
        ra dec \
