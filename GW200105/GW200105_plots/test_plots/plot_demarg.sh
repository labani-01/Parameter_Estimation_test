pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/ground_based_acc/separate_runs/GW200105/test_runs/demarg_cal_lambda_frame_model_sampler_cons.hdf \
    --output-file masses_cal_lambda_frame_model_sampler_cons.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/ground_based_acc/separate_runs/GW200105/test_runs/demarg_cal_lambda_frame_model_sampler_cons.hdf \
    --output-file spins_cal_lambda_frame_model_sampler_cons.png \
    --parameters \
...
pycbc_inference_plot_posterior --verbose\
    --input-file /home/lroy02/ground_based_acc/separate_runs/GW200105/test_runs/demarg_cal_lambda_frame_model_sampler_cons.hdf \
    --output-file extrinsic_cal_lambda_frame_model_sampler_cons.png \
    --parameters \
        ra dec \
